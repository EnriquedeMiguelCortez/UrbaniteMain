...
/**
 * @brief Lee el valor digital de un pin específico de un puerto GPIO.
 *
 * @param port Puntero al puerto GPIO (por ejemplo, GPIOA, GPIOB, etc.).
 * @param pin Número del pin dentro del puerto (0-15).
 * @return bool Estado del pin (true si es 1, false si es 0).
 */
bool GPIO_ReadPin(GPIO_TypeDef *port, uint16_t pin);

/**
 * @brief Escribe un valor digital en un pin específico de un puerto GPIO.
 *
 * @param port Puntero al puerto GPIO (por ejemplo, GPIOA, GPIOB, etc.).
 * @param pin Número del pin dentro del puerto (0-15).
...
/**
 * @brief Invierte el estado lógico de un pin específico de un puerto GPIO.
 *
 * @param port Puntero al puerto GPIO (por ejemplo, GPIOA, GPIOB, etc.).
 * @param pin Número del pin dentro del puerto (0-15).
 */
